...
from core.application.networks import EmbeddingModelSingleton
from core.domain.chunks import ArticleChunk, Chunk, PostChunk, RepositoryChunk
from core.domain.embedded_chunks import (
    EmbeddedArticleChunk,
    EmbeddedChunk,
    EmbeddedPostChunk,
    EmbeddedRepositoryChunk,
)
from core.domain.queries import EmbeddedQuery, Query
